...
const navigate=useNavigate();
  useEffect(() => {
    ...
    axios
      .get("https://ebc-training-and-research-center.onrender.com/tests/rf")
      .then((response) => {
  ...
  const submitSelectedQuestions = () => {
    ...
    axios
      .post("https://ebc-training-and-research-center.onrender.com/currents/rf", {
