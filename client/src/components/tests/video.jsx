...
const navigate=useNavigate();
  useEffect(() => {
    ...
    axios
      .get("https://ebc-training-and-research-center.onrender.com/tests/video")
      .then((response) => {
  ...
  const submitSelectedQuestions = () => {
    ...
    axios
      .post("https://ebc-training-and-research-center.onrender.com/currents/video", {
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="container pb-6 justify-between flex">
        <h1 className="text-3xl px-10 font-bold mb-4">
          Select Questions for Video Test
        </h1>
        <button
