...
const AudioTest = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://ebc-training-and-research-center.onrender.com/tests/audio")
      .then((response) => {
  ...
  const submitSelectedQuestions = () => {
    ...
    axios
      .post("https://ebc-training-and-research-center.onrender.com/currents/audio", {
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="container pb-6 justify-between flex">
        <h1 className="text-3xl px-10 font-bold mb-4">
          Select Questions for Audio Test
        </h1>
        <button
